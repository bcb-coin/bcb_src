...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
    {
        nSubsidy = 178000000 * COIN;	// 1 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2016/6/6 PM 6:00 build MetisCoin in fam.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
            block.print();
        assert(block.hashMerkleRoot == uint256("0xc589128c3ab43dc39db9dfb591f4fd9001ab54dbe47684c19683e5d2f5f19014"));
...
unsigned char pchMessageStart[4] = { 0x27, 0x14, 0x55, 0x6c };
